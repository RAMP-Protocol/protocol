...
revocation poll is anchored by the same rule as the endpoint.
...
that all three SDKs replay, so the three can no longer answer differently. Per-language
surface: `docs/sdk-parity-matrix.md`.
