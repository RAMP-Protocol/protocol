...
audience it breaks. What this change does instead is narrow what a conformant manifest may say. **An Exchange that serves its API from a separate domain — a CDN, a hosting provider — is
