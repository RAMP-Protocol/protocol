...
::proto-message{name=AgentRequestAcceptance}

### AgentRequestAcceptancePayload

The signed field set: ordered [`AgentRequestAcceptanceItem`](#agentrequestacceptanceitem) references plus the requester identity and idempotency key. Canonical bytes use the same RFC 8785 JCS over canonical proto-JSON rule as Offer and AgentAcceptance signatures.

::proto-message{name=AgentRequestAcceptancePayload}
...
::proto-message{name=AgentRequestAcceptanceItem}
