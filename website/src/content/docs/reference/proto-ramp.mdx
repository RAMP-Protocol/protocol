...
| 5 | FREE | No charge |
| ~~6~~ | ~~ATTRIBUTION~~ | **Retired.** Use `Obligation.kind = ATTRIBUTION` in a `LicenseTerm` instead. |
| ~~7~~ | ~~CONTRIBUTION~~ | **Retired.** Use `Obligation.kind = CONTRIBUTION` in a `LicenseTerm` instead. |
