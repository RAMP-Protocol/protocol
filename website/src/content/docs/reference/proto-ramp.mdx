...
Where a participant serves its identity documents, published as the optional `identity_documents` block on the manifest. Discovery metadata only — it does not change how a request signature is verified.
