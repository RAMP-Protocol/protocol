...
| `registration_schema` | object | No | JSON Schema (draft 2020-12) for the `registration_data` an agent sends to `Register`. Present means this Exchange enforces it; absent means `registration_data` passes through uninspected |
