...
- **Pricing**: `PRICING_MODEL_PER_ACCESS` at $0.05, with an estimated 3,200 tokens. The `unit_cost` ($0.0000156/token) enables cross-exchange comparison when a Broker aggregates offers.
