...
- **`id`** + **`domain`** — uniquely identifies the agent. The Exchange fetches the agent's Ed25519 public key from the WBA directory at `startup.com/.well-known/http-message-signatures-directory` (the domain resolved from the covered `Signature-Agent` header) to verify the request's RFC 9421 HTTP Message Signature.
  ...
  "offer_groups": [
    {
      ...
      "offers": [
        {
          "offer_id": "3a1cf96e-74b7-4c5d-abb0-925c3f83dfe3",
          "exchange": "exchange.ssp-alpha.com",
  ...
  "items": [
    {
      ...
      "retrieval_endpoint": "https://cdn.techcrunch.com/premium/ai-agents-commerce.html?agent_id=7a3f8c1d...&exp=1742403900&kid=vJ3xR1mQ...&sig=d4e5f6...",
      "cost": {
        "amount": "0.05",
        "currency": "USD"
      },
...
```bash
GET https://cdn.techcrunch.com/premium/ai-agents-commerce.html?agent_id=7a3f8c1d...&exp=1742403900&kid=vJ3xR1mQ...&sig=d4e5f6...
```
...
1. **Signature check** — the authority JWT is signed by `marketdata.example.com`'s Ed25519 key (fetched from the WBA directory at `marketdata.example.com/.well-known/http-message-signatures-directory`). This proves MarketData actually issued this delegation.
  ...
  "offer_groups": [
    {
      ...
      "offers": [
        {
          "offer_id": "c2301145-0f74-43af-be4e-eb8cd2a988be",
          "exchange": "exchange.marketdata-data.com",
  ...
  "items": [
    {
      ...
      "retrieval_endpoint": "https://cdn.marketdata.example.com/earnings/NVDA/2026-Q1-transcript.html?agent_id=8b4f9d2e...&exp=1742404200&kid=vJ3xR1mQ...&sig=a7b8c9...",
      "cost": {
        "amount": "0",
        "currency": "USD"
      },
