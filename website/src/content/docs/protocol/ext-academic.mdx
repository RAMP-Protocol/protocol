...
```json
{
  "offer_id": "6b3c368e-b867-4c77-beaf-04e5ef94d8df",
...
```json
{
  "offer_id": "4856ad87-d6a6-4a4e-a8a7-b3a3336d26c1",
  "exchange": "academic-exchange.example.com",
...
```json
{
  "offer_id": "713ba8aa-824c-470f-b6c6-f15e8a149df0",
  "exchange": "academic-exchange.example.com",
  ...
  "offer_groups": [
    {
      ...
      "offers": [
        {
          "offer_id": "cc5e3a6a-86c4-419e-ab1f-81138cfd19a1",
          "exchange": "academic-exchange.example.com",
    ...
    },
    {
      ...
      "offers": [
        {
          "offer_id": "6eb1e78d-d14d-472c-885e-7fa134d867f0",
          "exchange": "academic-exchange.example.com",
          "pricing": {
            "model": "PRICING_MODEL_PER_UNIT",
            "unit_cost": "2999",
...
```json
{
  "ver": "1.0",
  "exchange": "academic-exchange.example.com",
  "idempotency_key": "dispute_retraction_001",
