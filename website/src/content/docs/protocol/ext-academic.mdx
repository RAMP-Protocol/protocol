...
- `"closed"` articles: priced per article (`PRICING_MODEL_PER_UNIT` with `unit: "articles"`) or via subscription (FREE + subscription scope, see [Institutional Access](#institutional-access))
