...
<VocabTable axis="geography" />

**Standard user-type tokens**:

<VocabTable axis="user-type" />
...
<EnumTable enum="ObligationKind" label="Kind" />

<EnumTable enum="ObligationTrigger" label="Trigger" />
