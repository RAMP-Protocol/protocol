...
sequenceDiagram
    ...
    PUB-->>Agent: ProviderManifest (exchange endpoints)
...
|---|---|---|
| Check ramp.json | `ProviderManifest` | **RAMP** (exchange routing) |
...
sequenceDiagram
    ...
    Agent->>PUB: GET /.well-known/ramp.json
    PUB-->>Agent: ProviderManifest (exchange endpoint)
...
|---|---|---|
| `DISCOVERY_METHOD_MARKETPLACE` | 1 | Standard exchange catalog lookup |
