...
sequenceDiagram
    ...
    Orch-->>Agent: DiscoveryResponse (signed URL + cost + reporting obligation)
...
| Broker to Agent | `DiscoveryResponse` | **RAMP** |
...
sequenceDiagram
    ...
    Orch-->>Agent: DiscoveryResponse (3 signed URLs + costs)
