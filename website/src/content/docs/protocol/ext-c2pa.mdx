...
| Signature format | COSE Sign1 (RFC 9052) | Detached Ed25519 over RFC 8785 JCS (string encoding not yet pinned) |
...
COSE Sign1 signature    ──►        detached Ed25519 signature
...
|-----------|-------------|-------------|
| Ed25519 | Yes (EdDSA via COSE) | Yes (EdDSA, detached over JCS) |
| ECDSA P-256 | Yes | No |
| RSA | Yes | No |
