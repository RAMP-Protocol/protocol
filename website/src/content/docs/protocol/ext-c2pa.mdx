...
2. **Enforcement layer** (RAMP): The Exchange reads the C2PA declaration and enforces it commercially — an agent requesting `intended_use: "ai-train"` will not receive offers for content where training is prohibited.
