...
| TypeScript | [`gen/ts/`](https://github.com/RAMP-Protocol/protocol/tree/main/gen/ts/) (types) + [`sdk/ts/`](https://github.com/RAMP-Protocol/protocol/tree/main/sdk/ts/) (hand-written SDK: `src`, `core`, `resolvers`, `hono`) | Shipped and CI-gated; npm package not yet published | `@connectrpc/connect` + `@bufbuild/protobuf` |
| Python | [`gen/python/`](https://github.com/RAMP-Protocol/protocol/tree/main/gen/python/) (types) + [`sdk/python/`](https://github.com/RAMP-Protocol/protocol/tree/main/sdk/python/) (hand-written SDK: `ramp_sdk`, `ramp_sdk.core`, `ramp_sdk.resolvers`) | Shipped and CI-gated; PyPI package not yet published | `httpx` + `fastmcp` |
