...
<Aside type="note">
The TypeScript SDK is not yet published to npm; the example below is illustrative.
</Aside>
...
<Aside type="note">
The Python SDK is not yet published to PyPI; the example below is illustrative.
</Aside>
...
| TypeScript | — | Planned (npm package not yet published) | `@connectrpc/connect` + `@bufbuild/protobuf` |
| Python | — | Planned (PyPI package not yet published) | `httpx` + `fastmcp` |
