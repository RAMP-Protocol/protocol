...
<Aside type="note">
The TypeScript SDK is not yet published to npm. Use the working implementation at [`poc/agent-sdk/client.ts`](https://github.com/RAMP-Protocol/protocol/tree/main/poc/agent-sdk/client.ts).
</Aside>
...
<Aside type="note">
The Python SDK is not yet published to PyPI. See [`poc/mcp-tool/server.py`](https://github.com/RAMP-Protocol/protocol/tree/main/poc/mcp-tool/server.py) for the Python reference implementation using FastMCP.
</Aside>
...
```go
type Config struct {
    // Billing reference issued by the Exchange operator (cost-attribution
    // handle; not an entitlement — access is via scopes/delegation).
    BillingRef string
...
| TypeScript | [`poc/agent-sdk/client.ts`](https://github.com/RAMP-Protocol/protocol/tree/main/poc/agent-sdk/client.ts) | Working PoC (npm package planned) | `@connectrpc/connect` + `@bufbuild/protobuf` |
| Python | [`poc/mcp-tool/server.py`](https://github.com/RAMP-Protocol/protocol/tree/main/poc/mcp-tool/server.py) | Working PoC (PyPI package planned) | `httpx` + `fastmcp` |
