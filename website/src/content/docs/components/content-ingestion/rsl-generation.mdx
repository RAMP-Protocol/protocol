...
|---|---|
| `PricingModelPerArticle` | `purchase` |
| `PricingModelPerToken` | `use` |
| `PricingModelPerCrawl` | `crawl` |
| `PricingModelSubscription` | `subscription` |
| `PricingModelFree` | `free` |
| `PricingModelAttribution` | `attribution` |
| `PricingModelContribution` | `contribution` |
| `PricingModelTraining` | `training` |
...
For a tenant with defaults "per_article, $0.05, permits ai-input + search, prohibits ai-train":
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema"
  ...
  <xs:simpleType name="pricingModelType">
    <xs:restriction base="xs:string">
      <xs:enumeration value="per_article"/>
      <xs:enumeration value="per_token"/>
      <xs:enumeration value="per_crawl"/>
