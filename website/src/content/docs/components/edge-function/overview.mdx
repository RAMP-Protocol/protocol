...
handleRequest(ctx):
  1. If path == "/.well-known/ramp.json":
       ...
       -> For self-attesting providers, the verifier keys live in the WBA
          directory (/.well-known/http-message-signatures-directory) and the
          claims schema in ext["ramp.attestation.claims_schema"]
       -> Return 200
