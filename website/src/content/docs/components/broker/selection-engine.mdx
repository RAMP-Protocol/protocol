...
```go
func verifyOfferSignature(offer *rampv1.Offer, exchange string, pubKeys map[string]ed25519.PublicKey) error {
    if offer.Signature == "" {
    ...
    return helpers.VerifyOffer(offer, offer.Signature, key)
}
```
