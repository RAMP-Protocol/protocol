...
```go
func (o *Broker) Resolve(ctx context.Context, req *rampv1.RAMPRequest) (*rampv1.RAMPResponse, error) {
    ...
    if err != nil {
        ...
        // OK with RAMPResponse.absence_reason set and no retrieval_endpoint
        // (mirrors DiscoverResources). Non-OK errors are reserved for malformed
        // requests, auth failures, and internal faults.
        return &rampv1.RAMPResponse{AbsenceReason: o.absenceReason(err)}, nil
    }
