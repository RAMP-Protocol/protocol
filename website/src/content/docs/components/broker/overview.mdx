...
RAMP uses a two-layer signing model: the **Requester signature** proves who originated the request, and the **forwarding signature stack** proves which intermediaries forwarded it.
