...
This chain is modeled after OpenRTB schain (Supply Chain Object). When the agent queries an Exchange directly, `intermediaries` is empty. When the request passes through a Broker, it contains one hop.
