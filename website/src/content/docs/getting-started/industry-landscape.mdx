...
OpenRTB changed this by defining a common protocol that any exchange, DSP, or SSP could implement. The result: a liquid market where requesters and providers could transact across any compliant exchange.
