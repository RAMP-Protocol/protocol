...
1. Register your agent with a participating Exchange (`ExchangeService.Register`) — the Exchange creates your account and bills it based on your verified request signature
