...
- **Go**: Import generated types from [`gen/go/`](https://github.com/postindustria-tech/ramp-protocol/tree/main/gen/go/) and the Connect-Go client from `gen/go/ramp/v1/rampv1connect`. See [`poc/exchange/`](https://github.com/postindustria-tech/ramp-protocol/tree/main/poc/exchange/) for a working server example.
- **TypeScript**: See [`poc/agent-sdk/client.ts`](https://github.com/postindustria-tech/ramp-protocol/tree/main/poc/agent-sdk/client.ts) for the working `RampClient` implementation. The npm package is not yet published.
- **Python**: See [`poc/mcp-tool/server.py`](https://github.com/postindustria-tech/ramp-protocol/tree/main/poc/mcp-tool/server.py) for the Python reference implementation (FastMCP-based).
</Aside>
