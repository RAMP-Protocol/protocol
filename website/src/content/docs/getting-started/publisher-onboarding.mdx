...
## Publish ramp-verifier.json (Optional)

If you want to self-attest resources (Level 1 verification), publish your Ed25519 signing keys at:

```
https://{domain}/.well-known/ramp-verifier.json
```
...
| 5 | (Optional) Publish `ramp-verifier.json` for self-attestation | 10 min |
| **Total** | | **~30--45 min** |
