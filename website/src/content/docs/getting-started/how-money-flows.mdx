...
- Requester: Anthropic (Claude), with a registered account at SSP-Alpha (account handle `acct_7f3e21c9` — an opaque value minted by the Exchange at registration, meaningless on its own)
