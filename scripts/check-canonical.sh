...
cp gen/ts/wire/base.ts "$WORK/base.ts"   # schemas.ts imports the wire() message-policy seam
cp gen/ts/wire/names.ts "$WORK/names.ts" # ...which imports the shared field-name rule
