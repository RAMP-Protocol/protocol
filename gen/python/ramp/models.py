...
class RemoveResourcesResponse(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    removed: conint(ge=-2147483648, le=2147483647)
    ver: str


class Source(Enum):
    INGESTION_SOURCE_UNSPECIFIED = 'INGESTION_SOURCE_UNSPECIFIED'
...
class DisputeFailure(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    reason: Reason
...
class RestrictionMismatch(Enum):
    RESTRICTION_KIND_UNSPECIFIED = 'RESTRICTION_KIND_UNSPECIFIED'
...
class TransactionDenial(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    ...
    reason: Reason1
    restrictionMismatches: list[RestrictionMismatch] | None = Field(
        None,
...
class DenialReason(Enum):
    DENIAL_REASON_UNSPECIFIED = 'DENIAL_REASON_UNSPECIFIED'
    DENIAL_REASON_BILLING_REF_INACTIVE = 'DENIAL_REASON_BILLING_REF_INACTIVE'
    DENIAL_REASON_INSUFFICIENT_BALANCE = 'DENIAL_REASON_INSUFFICIENT_BALANCE'
    DENIAL_REASON_RATE_LIMITED = 'DENIAL_REASON_RATE_LIMITED'
    DENIAL_REASON_CONTENT_UNAVAILABLE = 'DENIAL_REASON_CONTENT_UNAVAILABLE'
...
class TransactionItem(BaseModel):
    ...
    offerId: str = Field(..., description='The offer_id from the selected Offer.')
    offerSignature: str = Field(
        ...,
...
class ReportingObligation(BaseModel):
    ...
    required: bool = Field(..., description='Whether post-usage reporting is required.')
...
class Obligation(BaseModel):
    ...
    kind: Kind = Field(..., description='What the agent must do.')
    ...
    trigger: Trigger = Field(..., description='When the obligation activates.')
...
class Status(Enum):
    DISPUTE_STATUS_UNSPECIFIED = 'DISPUTE_STATUS_UNSPECIFIED'
...
class DeliveryMethodsSupportedEnum(Enum):
    DELIVERY_METHOD_UNSPECIFIED = 'DELIVERY_METHOD_UNSPECIFIED'
    DELIVERY_METHOD_DIRECT = 'DELIVERY_METHOD_DIRECT'
    DELIVERY_METHOD_INSTRUCTIONS = 'DELIVERY_METHOD_INSTRUCTIONS'
    DELIVERY_METHOD_STREAMING = 'DELIVERY_METHOD_STREAMING'
...
class PricingModelsSupportedEnum(Enum):
...
class SupportedAuthMethod(Enum):
...
class KeyInvalidationList(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
...
class RetrievalAuthFailure(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    reason: Reason2
...
class ResourceAttestation(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
...
class Restriction(BaseModel):
    ...
    kind: Kind1 = Field(..., description='Which dimension this restriction applies to.')
    permitted: list[PermittedItem] | None = Field(
        None,
    ...
    prohibited: list[ProhibitedItem] | None = Field(
        None,
...
class AbsenceReason(Enum):
    OFFER_ABSENCE_REASON_UNSPECIFIED = 'OFFER_ABSENCE_REASON_UNSPECIFIED'
...
class AuthorizedExchange(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    domain: str = Field(..., description='Canonical domain of the Exchange.')
    endpoint: str = Field(..., description='RAMP ExchangeService endpoint URL.')
    ext: dict[str, Any] | None = None
    extCritical: list[str] | None = Field(
        None,
        description='Critical extension keys (COSE crit pattern, RFC 9052).\n Lists keys within ext that the consumer MUST understand.\n Unknown keys in this list → reject with UNKNOWN_CRITICAL_EXTENSION.\n Empty (default) → all ext keys are safe to ignore.',
...
class SubscriptionQuotaInfo(BaseModel):
    ...
    quotaLimit: conint(ge=-2147483648, le=2147483647) = Field(
        ..., description='Total allowed in the current period.'
    )
    quotaRemaining: conint(ge=-2147483648, le=2147483647) = Field(
        ..., description='Remaining in the current period.'
    )
    quotaUsed: conint(ge=-2147483648, le=2147483647) = Field(
        ..., description='Used so far in the current period.'
    )
    resetsAt: AwareDatetime | None = Field(
        None, description='When the quota counter resets (UTC).'
    )
    subscriptionId: str = Field(..., description='Subscription this quota applies to.')
    unit: str | None = Field(
        None,
...
class JsonWebKey(BaseModel):
    ...
    alg: str = Field(..., description='Signing algorithm. RAMP v1.0: MUST be "EdDSA".')
    crv: str = Field(..., description='Curve. RAMP v1.0: MUST be "Ed25519".')
    kid: str = Field(
        ...,
        description='Key ID. Unique within a single WellKnownManifest.public_keys list.',
    )
    kty: str = Field(..., description='Key type. RAMP v1.0: MUST be "OKP".')
    notAfter: str = Field(
        ...,
    ...
    use: str = Field(..., description='Intended key use. RAMP v1.0: MUST be "sig".')
    x: str = Field(..., description='base64url-encoded 32-byte Ed25519 public key.')
...
class DiscoveryMethod(Enum):
    DISCOVERY_METHOD_UNSPECIFIED = 'DISCOVERY_METHOD_UNSPECIFIED'
...
class CatalogContributor(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    domain: str = Field(
...
class PushResourcesResponse(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    accepted: conint(ge=-2147483648, le=2147483647)
    ext: dict[str, Any] | None = None
    extCritical: list[str] | None = Field(
        None,
        description='Critical extension keys (COSE crit pattern, RFC 9052).\n Lists keys within ext that the consumer MUST understand.\n Unknown keys in this list → reject with UNKNOWN_CRITICAL_EXTENSION.\n Empty (default) → all ext keys are safe to ignore.',
    )
    rejected: conint(ge=-2147483648, le=2147483647)
    ver: str
...
class CatalogRejection(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    reason: Reason4
...
class Cost(BaseModel):
    ...
    amount: float | Amount
    currency: str
    unitCost: float | UnitCost | None = None


class DomainVerificationConfirmation(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
...
class DomainVerificationFailure(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    reason: Reason5
...
class AttributionDetail(BaseModel):
    ...
    format: Format | None = Field(None, description='How the citation was presented.')
...
class DisputeRequest(BaseModel):
    ...
    billingId: str = Field(..., description='Billing reference from the transaction.')
    ...
    reason: Reason6 = Field(..., description='Reason for the dispute.')
    ...
    transactionId: str = Field(..., description='Transaction being disputed.')
    ver: str
...
class AcceptableRestriction(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    axis: Axis = Field(
...
class C2paStatus(Enum):
    C2PA_STATUS_UNSPECIFIED = 'C2PA_STATUS_UNSPECIFIED'
...
class RateLimitInfo(BaseModel):
    ...
    limit: conint(ge=-2147483648, le=2147483647) = Field(
        ..., description='Maximum requests allowed in the current window.'
    )
    remaining: conint(ge=-2147483648, le=2147483647) = Field(
...
class Pricing(BaseModel):
    ...
    model: Model1 = Field(..., description="Provider's pricing model.")
    ...
    unitCost: float | UnitCost | None = Field(
        None,
...
class RemoveResourcesRequest(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
...
class DeliveryPreferenceEnum(Enum):
    DELIVERY_METHOD_UNSPECIFIED = 'DELIVERY_METHOD_UNSPECIFIED'
    DELIVERY_METHOD_DIRECT = 'DELIVERY_METHOD_DIRECT'
    DELIVERY_METHOD_INSTRUCTIONS = 'DELIVERY_METHOD_INSTRUCTIONS'
    DELIVERY_METHOD_STREAMING = 'DELIVERY_METHOD_STREAMING'
...
class RequestConstraints(BaseModel):
    ...
    deliveryPreference: list[DeliveryPreferenceEnum] | None = Field(
    ...
    maxUnitCost: float | MaxUnitCost | None = Field(
...
class UsageReportRejection(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    reason: Reason7
...
class Delegation(BaseModel):
    ...
    token: constr(pattern=r'^[A-Za-z0-9+/]*={0,2}$') = Field(
        ...,
...
class TransactionResultItem(BaseModel):
    ...
    billingId: str = Field(..., description='Billing reference.')
    cost: Cost | None = Field(None, description='Cost for this item.')
    deliveryMethod: DeliveryMethod = Field(
        ..., description='How resource is delivered for this item.'
    )
    ...
    offerId: str = Field(..., description='The offer_id this result is for.')
...
class Offer(BaseModel):
    ...
    deliveryMethod: DeliveryMethod = Field(
        ..., description='How resource will be delivered.'
    )
    expiresAt: AwareDatetime | None = Field(
...
class Requester(BaseModel):
    ...
    type: Type = Field(..., description='What kind of entity is making this request.')


class WellKnownManifest(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    ...
    deliveryMethodsSupported: list[DeliveryMethodsSupportedEnum] | None = Field(
        None, description='Exchange-only. Supported delivery methods.'
    )
    domain: str = Field(..., description='Canonical domain serving this manifest.')
    endpoint: str | None = Field(
    ...
    pricingModelsSupported: list[PricingModelsSupportedEnum] | None = Field(
    ...
    supportedAuthMethods: list[SupportedAuthMethod] | None = Field(
        None,
...
class RAMPResponse(BaseModel):
    ...
    absenceReason: AbsenceReason | None = Field(
        None,
    ...
    deliveryMethod: DeliveryMethod = Field(
        ..., description='How resource is delivered.'
    )
    exchange: str = Field(..., description='Which Exchange won the selection.')
    expiresAt: AwareDatetime | None = Field(
        None, description='When retrieval_endpoint expires.'
    )
    ext: dict[str, Any] | None = None
    ...
    transactionId: str = Field(..., description='Exchange-assigned identifiers.')
    ver: str
...
class Usage(BaseModel):
    ...
    consumedQuantity: conint(ge=-2147483648, le=2147483647) = Field(
        ...,
...
class TransactionResponse(BaseModel):
    ...
    cost: Cost | None = None
    deliveryMethod: DeliveryMethod = Field(
        ..., description='How resource is delivered in this transaction.'
    )
    expiresAt: AwareDatetime | None = Field(
        None, description='When retrieval_endpoint expires.'
    )
...
class OfferGroup(BaseModel):
    ...
    restrictionFilters: list[RestrictionFilter] | None = Field(
        None,
...
class UsageReport(BaseModel):
    ...
    billingId: str = Field(..., description='Billing reference from the delivery.')
    ...
    transactionId: str = Field(..., description='Transaction ID from the delivery.')
...
class ResourceQuery(BaseModel):
    ...
    ver: str = Field(..., description='RAMP protocol version.')
...
class PushResourcesRequest(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    callerId: str = Field(
