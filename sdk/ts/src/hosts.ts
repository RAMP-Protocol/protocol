...
//
// Deliberately NOT built on `hostAnchored` further down this file, which
// ../resolvers/wba.ts now shares: that one implements the endpoint rule, host or
// subdomain, and this field refuses a subdomain. Whoever takes over the host an endpoint names misdirects calls they
