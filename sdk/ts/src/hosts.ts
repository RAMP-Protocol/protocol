 ...
 * domain-valued field in ramp.proto — one definition, so the check a client
 ...
 * a value whose length differs between UTF-16 units, code points and bytes
 ...
 *
 * `self` is this Exchange's own bare domain. `claimed` holds the recipient
